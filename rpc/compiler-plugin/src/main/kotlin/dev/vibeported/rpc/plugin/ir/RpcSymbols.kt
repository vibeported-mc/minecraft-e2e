...
internal class RpcSymbols(private val context: IrPluginContext) {
    ...
    val liftedBody: IrClassSymbol = classOf(CORE, "LiftedBody")

    /** `LiftedBody(id, role, argSerializers, resultSerializer)`. */
    val liftedBodyConstructor: IrConstructorSymbol = liftedBody.constructors.single()
