...
dependencies {
    ...
    api(project(":capture:libav-gen"))
}

@Suppress("UNCHECKED_CAST")
val nativesDir = project(":capture").extra["nativesDir"] as Provider<Directory>
val buildNatives = project(":capture").tasks.named("buildNatives")
