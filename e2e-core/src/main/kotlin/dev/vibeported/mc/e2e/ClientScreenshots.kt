 ...
 * the file system.
 *
 * It returns only once the file exists. The capture is a read back from the GPU that lands a few
 * frames later, and a test that carried on regardless would be writing shots of a scene it had
 * already changed.
 */
public suspend fun ClientScope.makeScreenshot(name: String): File {
