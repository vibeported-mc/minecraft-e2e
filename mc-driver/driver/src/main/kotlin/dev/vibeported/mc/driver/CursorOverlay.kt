...
import dev.vibeported.mc.driver.mixin.CursorRequestAccessor
...
internal object CursorOverlay {
    ...
    private fun cursorTexture(name: String) =
        Identifier.fromNamespaceAndPath(DriverMod.ID, "textures/gui/cursor/$name.png")

    private fun mouseTexture(part: String) =
        Identifier.fromNamespaceAndPath(DriverMod.ID, "textures/gui/mouse/$part.png")
